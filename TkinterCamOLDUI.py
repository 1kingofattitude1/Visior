...
class RcModeController:
    ...
    def on_press(self, key):
        ...
        if str(format(key)) == "'w'":
            self.CamUp.config(bg = b_g, fg = f_g, font = ("Courier bold", 12))
        if str(format(key)) == "'s'":
            self.CamDown.config(bg = b_g, fg = f_g, font = ("Courier bold", 12))
        if str(format(key)) == "'a'":
            self.CamLeft.config(bg = b_g, fg = f_g, font = ("Courier bold", 12))
        if str(format(key)) == "'d'":
            self.CamRight.config(bg = b_g, fg = f_g, font = ("Courier bold", 12))
    ...
    def on_release(self, key):
        ...
        #border_w = 1
        if str(format(key)) == "'w'":
            self.CamUp.config(bg = b_g, fg = f_g, font = ("Courier bold", 11))
        if str(format(key)) == "'s'":
            self.CamDown.config(bg = b_g, fg = f_g, font = ("Courier bold", 11))
        if str(format(key)) == "'a'":
            self.CamLeft.config(bg = b_g, fg = f_g, font = ("Courier bold", 11))
        if str(format(key)) == "'d'":
            self.CamRight.config(bg = b_g, fg = f_g, font = ("Courier bold", 11))
        if str(format(key)) == "Key.up":
    ...
    def StreamScreen(self):
        try:
            ...
            Button(self.window, font = ("Courier bold", 11), text = "\u25A3 " + "Snapshot", command = self.SaveFrame,
                   ...
                   fg = "black",
                   borderwidth = 0, highlightthickness = 0, activebackground = "black",
                   activeforeground = "white" ).place(relx = 0.013, rely = 0.57)
            Button(self.window, font = ("Courier bold", 11), text = "\u25CF " + "Record", command = self.SaveFrame,
                   width = 10,
                   bg = "#2ade2a",
                   fg = "black",
                   borderwidth = 0, highlightthickness = 0, activebackground = "black",
                   activeforeground = "white").place(relx = 0.013 * 2 + 0.15, rely = 0.57)
    ...
    def CreateCameraButtons(self):
        ...
        self.CamUp = Button(self.window, font = ("Courier bold", 11), text = "\u25b2", width = 4,
                            fg = "#2ade2a",
                            bg = "black",
                            borderwidth = 0, highlightthickness = 0, activebackground = "black",
                            activeforeground = "white")
        self.CamUp.place(relx = 0.25, rely = 0.73)
        self.CamRight = Button(self.window, font = ("Courier bold", 11), text = "\u25ba", width = 4,
                               fg = "#2ade2a",
                               bg = "black",
                               borderwidth = 0, highlightthickness = 0, activebackground = "black",
                               activeforeground = "white")
        self.CamRight.place(relx = 0.343, rely = 0.8)
        self.CamDown = Button(self.window, font = ("Courier bold", 11), text = "\u25bc", width = 4,
                              fg = "#2ade2a",
                              bg = "black",
                              borderwidth = 0, highlightthickness = 0, activebackground = "black",
                              activeforeground = "white")
        self.CamDown.place(relx = 0.25, rely = 0.83)
        self.CamLeft = Button(self.window, font = ("Courier bold", 11), text = "\u25c4", width = 4,
                              fg = "#2ade2a",
                              bg = "black",
                              borderwidth = 0, highlightthickness = 0, activebackground = "black",
                              activeforeground = "white")
        self.CamLeft.place(relx = 0.16, rely = 0.8)
        Label(self.window, font = ("Arial", 7), justify = "left",
              text = "W=Look Up\n\nS=Look Down\n\nA=Look Left\n\nD=Look Right",
    ...
    def CreateMovementButton(self):
        ...
        self.MoveForward = Button(self.window, font = ("Courier bold", 14), text = "\u2191", width = 4,
                                  bg = "black",
                                  fg = "red",
                                  borderwidth = 0, highlightthickness = 0, activebackground = "black",
                                  activeforeground = "white")
        self.MoveForward.place(relx = 0.7, rely = 0.72)
        self.MoveBackward = Button(self.window, font = ("Courier bold", 14), text = "\u2193", width = 4,
                                   bg = "black",
                                   fg = "red",
                                   borderwidth = 0, highlightthickness = 0, activebackground = "black",
                                   activeforeground = "white")
        self.MoveBackward.place(relx = 0.7, rely = 0.8)
        self.TurnLeft = Button(self.window, font = ("Courier bold", 14), text = "\u2190", width = 4,
                               bg = "black",
                               fg = "red",
                               borderwidth = 0, highlightthickness = 0, activebackground = "black",
                               activeforeground = "white")
        self.TurnLeft.place(relx = 0.62, rely = 0.8)
        self.TurnRight = Button(self.window, font = ("Courier bold", 14), text = "\u2192", width = 4,
                                bg = "black",
                                fg = "red",
                                borderwidth = 0, highlightthickness = 0, activebackground = "black",
                                activeforeground = "white")
