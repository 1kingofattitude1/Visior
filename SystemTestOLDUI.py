    ...
    def MainMenu(self):
        try:
            ...
            Label(self.SysWindow, font = ("Courier bold", 9),
                  text = "Click on the checkboxe's to select and then \nClick 'Start Test' button at the bottom of "
                         "screen to start tests \n ''you can also run multpile tests''",
                  width = self.win_width,
                  fg = "#2ade2a",
                  bg = "black").pack(side = "top")

            Button(self.SysWindow, font = ("Courier bold", 13), text = "Start Tests >", width = len("Start Tests >"),
                   highlightthickness = 0, bg = "#2ade2a",
                   fg = "black", borderwidth = 0, command = self.getCheckBoxState, activebackground = "black",
                   activeforeground = "white").pack(side = "bottom", pady = 5)
